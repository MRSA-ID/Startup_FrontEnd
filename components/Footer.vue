      ...
      <div class="sm:flex mb-4">
        <div class="sm:w-1/2 sm:mt-0 mt-8 h-auto">
          <div class="flex items-center mb-3">
            ...
            <span class="font-bold text-2xl"> GoFund </span>
          </div>
          <p class="font-light">
        ...
        <div class="sm:w-1/4 h-auto">
          ...
          <ul class="font-light">
            <li class="mb-3">+021 0000 0000</li>
            <li class="mb-3">KBP, Jakarta</li>
            <li class="mb-3">No.12 (Gofund)</li>
            <li class="mb-3">support@gofund.id</li>
          </ul>
        </div>
      </div>
    </div>
