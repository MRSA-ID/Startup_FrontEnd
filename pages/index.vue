  ...
  <div class="landing-page">
    ...
    <section class="container mx-auto pt-24">
      ...
      <div class="grid px-10 md:px-0 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-3">
        ...
        >
          <div class="item">
            <figure class="item-image w-full h-80 rounded-20 overflow-hidden">
              <img
                :src="$axios.defaults.baseURL + campaign.image_url"
                :alt="'images_campaign' + campaign.id"
                class="w-full object-[center_top] object-cover"
              />
            </figure>
            <div class="item-meta">
              ...
              <div class="relative pt-4 progress-bar">
                <div
                  class="overflow-hidden h-2 mb-4 text-xs flex rounded bg-gray-200 2xl:h-3 2xl:rounded-lg"
                >
                  <div
                    :style="
                      'width: ' +
