  ...
  <div class="container mx-auto h-screen flex justify-center items-center">
    <div class="w-full lg:w-1/3 px-10 lg:px-0">
      <div class="flex justify-center items-center mx-auto mb-4 w-40">
        <div class="relative">
          <div class="cursor-pointer w-40 h-40" @click="$refs.file.click()">
            <img
              :src="url"
              alt=""
              class="rounded-full w-full h-full object-cover object-top border-white border-4"
            />
            <img
              src="/icon-avatar-add.svg"
              alt=""
              class="absolute right-3  bottom-0 pb-2"
            />
