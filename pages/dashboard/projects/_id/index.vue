    ...
    <section class="container mx-auto pt-8">
      ...
      <div class="block mb-2">
        <div class="w-full lg:max-w-full lg:flex mb-4">
          <div
            class="border border-gray-400 bg-white rounded p-8 flex flex-col justify-between leading-normal w-full"
          >
            <div>
              ...
              <p class="lg:text-4xl text-gray-700 text-base">
                Rp.{{
      ...
      <div class="grid grid-cols-4 gap-4 -mx-2">
        <div
          ...
          :key="image.image_url"
        >
          <figure class="item-thumbnail rounded w-full h-full overflow-hidden">
            <img
              :src="$axios.defaults.baseURL + image.image_url"
              :alt="image.image_url.split('/')[1]"
